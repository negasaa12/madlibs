...
def your_story():
    ...
    chosen_story = Story(**session["story"]).template.format(**present_args)
    return render_template ('stories.html', chosen_story=chosen_story)
